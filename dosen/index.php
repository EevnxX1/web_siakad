...
include"../koneksi.php";
$sqluser = mysqli_query($con, "select * from tbl_dosen where nidn_dosen = '$_SESSION[nidndosen]' ");
    ...
    <div id="wrapper">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="index.php?page=jadwal_perkuliahan">Jadwal Perkuliahan</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Welcome Dosen, <?php echo"$ru[nm_dosen]" ?></span>
            ...
            switch($page){
                ...
                include "jadwal_perkuliahan.php";
                break;
